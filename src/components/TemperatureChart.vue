...
export default {
  ...
  methods: {
    showPosition(position) {
      ...
      axios.get(`https://api.open-meteo.com/v1/forecast?latitude=${position.coords.latitude}&longitude=${position.coords.longitude}&daily=apparent_temperature_max&timezone=UTC&past_days=2`)
      .then((response) => {
